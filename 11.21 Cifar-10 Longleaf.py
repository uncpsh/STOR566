...
def main():
    ...
    models_to_run = {
        ...
        'vit_msa': lambda: ViTMSA(img_size=32, patch_size=4, num_classes=num_classes),
        'vit_vanilla': lambda: ViTVanilla(img_size=32, patch_size=4, num_classes=num_classes),
        'hilovit': lambda: HiLoViT(img_size=32, patch_size=4, num_classes=num_classes,
                                   embed_dim=192, depth=6, num_heads=6,
                                   window_size=2, alpha=0.5),
    }
